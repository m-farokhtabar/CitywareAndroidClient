...
public class BasketDeliveryFragment extends Fragment implements IResponseService, ILoadData {
    ...
    private static BasketUserAddressRecyclerViewAdapter basketUserAddressRecyclerViewAdapter = null;

    public static BasketUserAddressRecyclerViewAdapter getBasketUserAddressRecyclerViewAdapter() {
