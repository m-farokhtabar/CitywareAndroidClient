...
public class UserFactorBusinessOpenTimeRecyclerViewAdapter extends RecyclerView.Adapter<UserFactorBusinessOpenTimeRecyclerViewAdapter.ViewHolder>  {
    ...
    public UserFactorBusinessOpenTimeRecyclerViewAdapter(UserFactorDetailActivity context, int layoutResourceId, List<BusinessOpenTimeViewModel> ViewModel, RecyclerView Container) {
