...
public class MarketerFactorDetailsRecyclerViewAdapter extends RecyclerView.Adapter<MarketerFactorDetailsRecyclerViewAdapter.ViewHolder> {

    private List<Marketing_CustomerFactorDetailsViewModel> ViewModelList = null;

    public MarketerFactorDetailsRecyclerViewAdapter( List<Marketing_CustomerFactorDetailsViewModel> ViewModel) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View CurrentView = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_view_marketer_factor_details, parent, false);
