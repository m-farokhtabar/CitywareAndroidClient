...
public class BusinessDetailsContactRecyclerViewAdapter extends RecyclerView.Adapter<BusinessDetailsContactRecyclerViewAdapter.ViewHolder> {

    private List<BusinessContactViewModel> ViewModelList = null;
    private RecyclerView Container = null;
    private ShowBusinessDetailsActivity Context;

    public BusinessDetailsContactRecyclerViewAdapter(ShowBusinessDetailsActivity context, List<BusinessContactViewModel> ViewModel, RecyclerView Container) {
    ...
    private void Call(Context CurrentContext, String PhoneNumber) {
