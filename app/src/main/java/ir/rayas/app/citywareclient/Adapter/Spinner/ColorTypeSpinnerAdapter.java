...
public class ColorTypeSpinnerAdapter extends BaseAdapter {

    Context context;
    List<ColorTypeViewModel> ColorTypeViewModels;
    LayoutInflater inflter;

    public ColorTypeSpinnerAdapter(Context applicationContext,  List<ColorTypeViewModel> colorTypeViewModels) {
