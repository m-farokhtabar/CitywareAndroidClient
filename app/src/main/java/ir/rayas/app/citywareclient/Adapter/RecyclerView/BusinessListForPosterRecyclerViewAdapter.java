...
public class BusinessListForPosterRecyclerViewAdapter extends RecyclerView.Adapter<BusinessListForPosterRecyclerViewAdapter.ViewHolder> {

    private List<BusinessViewModel> ViewModelList = null;
    private BuyPosterTypeActivity Context;
    private MyClickListener myClickListener;

    public BusinessListForPosterRecyclerViewAdapter(BuyPosterTypeActivity context, List<BusinessViewModel> ViewModel) {
