...
public class UserAddressDialogSearchRecyclerViewAdapter extends RecyclerView.Adapter<UserAddressDialogSearchRecyclerViewAdapter.ViewHolder> {

    private List<UserAddressViewModel> ViewModelList = null;
    private SearchActivity Context;

    public UserAddressDialogSearchRecyclerViewAdapter(SearchActivity MyContext,List<UserAddressViewModel> ViewModel) {
