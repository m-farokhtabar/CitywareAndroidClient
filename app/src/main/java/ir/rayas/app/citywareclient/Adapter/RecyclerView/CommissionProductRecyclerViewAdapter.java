...
public class CommissionProductRecyclerViewAdapter extends RecyclerView.Adapter<CommissionProductRecyclerViewAdapter.ViewHolder> {

    private List<ProductCommissionAndDiscountViewModel> ViewModelList = null;
    private CommissionActivity Context;

    public CommissionProductRecyclerViewAdapter(CommissionActivity context, List<ProductCommissionAndDiscountViewModel> ViewModel) {
